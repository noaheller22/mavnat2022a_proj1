from AVLNode_class import AVLTreeList
import unittest
...
class testAVLList(unittest.TestCase):
    ...
    def test_delete_list_with_only_one_element(self):
        ...
        self.assertIsNone(T.firstNode)
        self.assertIsNone(T.lastNode)
    ...
    def check_BF(self, node, tree):
        if not abs(node.getLeft().getHeight() - node.getRight().getHeight()) < 2:
